...
export const DEFAULT_CONFIG = {
  ...
  MIN_READ_SECONDS: 60,      // min seconds on the gate before an article can be submitted (invisible anti-gaming timer)
  DEFAULT_UNLOCK_MINUTES: 15, // how long one completed read keeps a blocked site open when the
                              //   site has no per-site value yet. Users customize this PER site
                              //   in the dashboard (Settings → Blocked sites → Unlock time per site).
