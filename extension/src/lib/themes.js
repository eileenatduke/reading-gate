...
export const THEMES = {
  ...
  solidRuby:   { group:'solid', name:'Deep ruby', appBg:'linear-gradient(160deg,#eafff0 0%,#dfffdb 100%)', surface:'#f0fff0', surface2:'#dff5db', border:'#bfeaba', text:'#4a1024', muted:'#8a5266', faint:'#e6becb', accent:'#a30b3a', accentRgb:'163,11,58', accent2:'#7d0a30', shadow:'0 20px 40px -24px rgba(74,16,36,.22)', blur:'none' },
