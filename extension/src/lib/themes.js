...
export const THEMES = {
  ...
  solidButter: { group:'solid', name:'Butter', appBg:'linear-gradient(160deg,#fff2c2 0%,#ffedac 100%)', surface:'#fff7d6', surface2:'#ffe79a', border:'#e7d199', text:'#3E2723', muted:'#6f5850', faint:'#a08b7f', accent:'#3E2723', accentRgb:'62,39,35', accent2:'#5b3f37', shadow:'0 20px 40px -24px rgba(62,39,35,.25)', blur:'none' },
  solidHotpink:{ group:'solid', name:'Hot pink', appBg:'#ffe1ef', surface:'#ffffff', surface2:'#ffd6ec', border:'#ffbdde', text:'#5a1236', muted:'#a1476f', faint:'#d18aab', accent:'#ff2d8e', accentRgb:'255,45,142', accent2:'#a626d3', shadow:'0 20px 40px -24px rgba(90,18,54,.22)', blur:'none' },
  solidNavy:   { group:'solid', name:'Ice & blaze', appBg:'linear-gradient(160deg,#d4f2ff 0%,#bfedff 100%)', surface:'#eefaff', surface2:'#d4f0fb', border:'#a6dcf0', text:'#5a2600', muted:'#95643a', faint:'#c19a76', accent:'#fd6c01', accentRgb:'253,108,1', accent2:'#e35d00', shadow:'0 20px 40px -24px rgba(90,38,0,.22)', blur:'none' },
  solidRuby:   { group:'solid', name:'Deep ruby', appBg:'linear-gradient(160deg,#eafff0 0%,#dfffdb 100%)', surface:'#f0fff0', surface2:'#d3f7cf', border:'#bfeaba', text:'#5c0722', muted:'#8a3b53', faint:'#bd8598', accent:'#a30b3a', accentRgb:'163,11,58', accent2:'#7d0a30', shadow:'0 20px 40px -24px rgba(92,7,34,.22)', blur:'none' },
